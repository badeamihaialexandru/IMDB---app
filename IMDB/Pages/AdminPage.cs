...
namespace IMDB
{
    ...
    {
        private Form ParentPageAdminPage;
        private string MemberUserName;
        private string drepturi;

        public AdminPage(string AdminName, Form startpage)
        {
            InitializeComponent();
                                                        ...
                                                        if (pictureBoxPoza.ImageLocation != null)
                                                        {
                                                            ...
                                                            else if (UpdateCheckBox.Checked == true)
                                                            {
                                                                ...
                                                                if (!label11.Text.Equals("ID*:"))
                                                                {
                                                                    ...
                                                                    {
                                                                        string abc = CalculateMD5Hash(textBox2.Text);
                                                                        context.UpdateUserbyName(textBox7.Text, textBox1.Text,CalculateMD5Hash( textBox2.Text), textBox4.Text, textBox5.Text, rights, ConvertFiletoByte(pictureBoxPoza.ImageLocation));
                                                                        context.SaveChanges();
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        context.UpdateUserbyID(b, textBox1.Text,CalculateMD5Hash( textBox2.Text), textBox4.Text,textBox5.Text, rights, ConvertFiletoByte(pictureBoxPoza.ImageLocation));
                                                                        context.SaveChanges();
                                                                        MessageBox.Show("User updatat cu succes!");
                                                                    }
                                                                }
