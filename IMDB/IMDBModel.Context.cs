...
namespace IMDB
{
    ...
    public partial class IMDBEntities : DbContext
    {
        ...
        public virtual DbSet<WatchlistSeriale> WatchlistSeriales { get; set; }
        public virtual DbSet<YourRatingsSerial> YourRatingsSerials { get; set; }
        ...
        public virtual ObjectResult<SearchByMovies_Result> SearchByMovies(string nume)
        {
            var numeParameter = nume != null ?
                new ObjectParameter("nume", nume) :
                new ObjectParameter("nume", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchByMovies_Result>("SearchByMovies", numeParameter);
        }
    
        public virtual ObjectResult<WhoIsBornToday_Result> WhoIsBornToday(Nullable<System.DateTime> today)
        {
            var todayParameter = today.HasValue ?
                new ObjectParameter("today", today) :
                new ObjectParameter("today", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<WhoIsBornToday_Result>("WhoIsBornToday", todayParameter);
        }
    }
}
